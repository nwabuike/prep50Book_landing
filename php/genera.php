...
if ((isset($_POST['fullname']) && $_POST['fullname'] != '')) {
    ...
    $sql = "INSERT INTO users (fullname, email, phone, address, jambSoftSciBundle, jambSoftArtBundle, waecSoftSciBundle, waecSoftArtBundle, created_at) 
VALUES('".$user_name."', '".$user_email."', '".$user_phone."', '".$user_address."','".$user_bundle_jamb_sci."', '".$user_bundle_jamb_art."',  '".$user_bundle_waec_sci."',  '".$user_bundle_waec_art."', now())";
// echo $sql;
